...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #Создание продуктов
        product1 = Product.objects.create(name='Тест1', description='Описание1', category=one, price=10)
        product2 = Product.objects.create(name='Тест2', description='Описание2', category=two, price=100)
